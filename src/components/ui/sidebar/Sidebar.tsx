 ...
 */}
 ...
 <nav className="fixed p-5 right-0 top-0 w-[500px] h-screen bg-white z-20 shadow-2xl transform transition-all duration-300">
    ...
    <IoCloseOutline size={50} className="absolute top-5 right-5 cursor-pointer" onClick={() => console.log('cli')
    }/>
    ...
    {/* Menu */}
    <Link href='' className="flex items-center mt-10 p-2 hover:bg-gray-100">
